...
# VENDORED from vs_temporalfix (https://github.com/pifroggi/vs_temporalfix)
# Architecture and models by pifroggi (tepete and pifroggi on Discord).
# License: Apache-2.0. Vendored unmodified (header added) for CM-078 --
# ChitraMaya's temporal stabilizer runs this arch in-process with the
# official .pth weights, no VapourSynth required. Flow prediction and
# masking idea from RIFE (https://github.com/hzwer/ECCV2022-RIFE).
